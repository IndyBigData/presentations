...
public final class GroupLensRecommender implements Recommender {
  ...
  public GroupLensRecommender() throws IOException, TasteException {
    this("../datasets/dummy-bool.csv");
    //System.out.println("in GroupLensRecommender constructor");
    //DataSource dataSource = new DataSource
    //DataModel model = new PostgreSQLJDBCDataModel(dataSource, "ratings", "user_id", "deal_id", "rating", "created_at") 
  ...
  public String toString() {
    ...
    return "hello from my GroupLensRecommender";
  }
